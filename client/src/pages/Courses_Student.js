    ...
    return (
        ...
        <div> 
          ...
          <div className="position">
            ...
            <Filter search={search}  placeholder='Type your search' searchkey={searchhandle} className="filter" style={{marginLeft:1100}}></Filter><br></br>
           <p style={{ display:'flex', alignContent:'center' ,flexWrap: 'wrap',marginLeft:100}} >
